      ...
      <section className="bg-gray-50 rounded-3xl md:py-16 py-10 md:px-10 px-1">
        <div className="md:ml-3 container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 flex  justify-center">
            <img
              src="/images/professional-moving-company-hamdan.jpg" // replace with your image path
          ...
          {/* Right Side - Content */}
          <div className="md:-ml-28 md:-mt-0 -mt-20 rounded-lg shadow-lg shadow-neutral-100 bg-white p-4 md:w-1/2 md:pl-10 text-center md:text-left">
            ...
            <p className="text-gray-600 mb-6">
              ...
              continuously improving our services to ensure safe, timely moves.
              Count on us for a smooth, efficient relocation experience
            </p>
            ...
            <div className="flex justify-center md:justify-start space-x-8 text-gray-800">
              ...
              <div className="text-center">
                <h3 className="text-3xl font-bold">2,212+</h3>
